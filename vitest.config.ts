  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        // Phase 13 - Arduino C++ Generator
        "src/core/services/codegen/arduino/ArduinoCppGenerator.ts": { statements: 85, branches: 75, functions: 85, lines: 85 },
        "src/core/services/codegen/arduino/ArduinoValidator.ts": { statements: 95, branches: 80, functions: 95, lines: 95 },
        "src/core/services/codegen/arduino/ArduinoBlockRegistry.ts": { statements: 100, branches: 100, functions: 100, lines: 100 },
        "src/core/services/codegen/arduino/BlockGenerators.ts": { statements: 90, branches: 80, functions: 90, lines: 90 },
        "src/core/services/codegen/arduino/GenerationContext.ts": { statements: 90, branches: 75, functions: 85, lines: 90 },
      },
